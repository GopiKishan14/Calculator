...
def press(num): 
    ...
    if num is '+' :
        str1 = openedfile.read()
        openedfile = open("input.txt", "w")
        openedfile.write("00\n")
        openedfile.write(str1 + '\n')
    elif num is '-' :
        str1 = openedfile.read()
        openedfile = open("input.txt", "w")
        openedfile.write("01\n")
        ...
        openedfile.seek(0,2)
        openedfile.write(bin(num)[2:].zfill(4))
...
def equalpress(): 
    ...
    try: 
        ...
        total = str(int(openedfile.read(),2)) 
        
        # openedfile = open('output.txt', 'w')
        # openedfile.close()
        equation.set(total) 
...
if __name__ == "__main__": 
    ...
    plus = Button(gui, text=' ADD ', fg='black', bg='yellow', 
            command=lambda: press("+"), height=1, width=7) 
    plus.grid(row=2, column=3) 

    minus = Button(gui, text=' SUB ', fg='black', bg='yellow', 
            command=lambda: press("-"), height=1, width=7) 
    minus.grid(row=3, column=3) 

    multiply = Button(gui, text=' OR ', fg='black', bg='yellow', 
            command=lambda: press("o"), height=1, width=7) 
    multiply.grid(row=4, column=3) 

    divide = Button(gui, text=' 2s Comp. ', fg='black', bg='yellow', 
